...
class Isod:
    ...
    def getPlan(login, password):
        url = 'https://isod.ee.pw.edu.pl/isod-portal/wapi?q=myplan&username=' + login + '&apikey=' + Isod.getAPI(
    ...
    def getNews(login, password):
        url = 'https://isod.ee.pw.edu.pl/isod-portal/wapi?q=mynewsheaders&username=' + login + '&apikey=' + Isod.getAPI(
            login, password)
        n = requests.post(url)
        news = n.text
        return news
